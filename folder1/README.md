...
Learned how to design and implement a star schema for a retail sales warehouse. Understood how NoSQL (MongoDB) handles flexible product data with nested documents and dynamic attributes. Gained experience with ETL pipelines to extract, transform, and load data into relational and warehouse systems. Developed OLAP queries to perform drill-down, top-N analysis, and customer segmentation.
